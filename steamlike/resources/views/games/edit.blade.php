<x-app-layout>
    <div>
        ...
        <form action="{{ route("games.update", ['game' => $game])}}" method="post">
            ...
            <label for="description">Description</label><textarea id="description" name="description">{{$game->name}}</textarea><br>
            ...
            <input type="number" id="promotion" name="promotion" placeholder="Promotion amout">
            <br><br>
